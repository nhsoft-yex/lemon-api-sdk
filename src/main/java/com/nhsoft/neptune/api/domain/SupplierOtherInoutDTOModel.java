...
/**
 * SupplierOtherInoutDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class SupplierOtherInoutDTOModel extends ApiCloudObject {

    @ApiCloudField(value="费用单号", example="OP2072010000016")
    private String otherInoutFid;
    @ApiCloudField(value="门店编码", example="99")
    private Integer branchNum;
    @ApiCloudField(value="供应商编码", example="434400009")
    ...
    @ApiCloudField(value="费用时间 格式：yyyy-MM-dd HH:mm:ss", example="2021-01-27 00:00:00")
    ...
    @ApiCloudField(value="销售金额（小数点2位）", example="100.0")
    private BigDecimal otherInoutMoneyAll;
