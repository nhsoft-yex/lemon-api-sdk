...
public class InnerFindV2DTOModel extends ApiCloudObject {

    @ApiCloudField(value="被申请门店编码", example="99", required=true)
    ...
    @ApiCloudField(value="结束时间(yyyy-MM-dd)(与date_from时间间隔不能超过5天)", example="2021-01-01", required=true)
    private String dateTo;
    @ApiCloudField(value="时间类型（制单时间|审核时间|批复时间|处理时间）", example="制单时间", required=true)
