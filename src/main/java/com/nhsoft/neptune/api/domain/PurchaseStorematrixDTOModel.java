...
/**
 * PurchaseStorematrixDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class PurchaseStorematrixDTOModel extends ApiCloudObject {

    @ApiCloudField(value="商品编码", example="434400001")
    private Integer itemNum;
    @ApiCloudField(value="基础库存（小数点两位）", example="10.0")
    private BigDecimal baseStock;
    @ApiCloudField(value="补货订购点（小数点三位）", example="10.0")
    private BigDecimal recorderPoint;
    @ApiCloudField(value="补货订购量（小数点三位）", example="10.0")
    private BigDecimal recorderQty;
    @ApiCloudField(value="库存上限（小数点三位）", example="10.0")
