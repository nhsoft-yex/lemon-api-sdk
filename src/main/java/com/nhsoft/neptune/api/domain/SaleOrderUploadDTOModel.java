...
public class SaleOrderUploadDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="订单商品明细列表", required=true)
    ...
    @ApiCloudField(value="门店名", required=true)
    private String storeName;
    @ApiCloudField(value="门店地址", required=true)
    private String storeAddress;
    @ApiCloudField(value="商家收入，单位(分)", example="1000", required=true)
    private Integer income;
    @ApiCloudField(value="收货人姓名", required=true)
    private String receiverName;
    @ApiCloudField(value="收货人地址")
    private String receiverAddress;
    @ApiCloudField(value="收货人手机号", required=true)
