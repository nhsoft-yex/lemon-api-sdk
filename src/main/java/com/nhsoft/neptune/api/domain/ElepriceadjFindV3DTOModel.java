...
/**
 * ElepriceadjFindV3DTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ElepriceadjFindV3DTOModel extends ApiCloudObject {

    @ApiCloudField(value="申请门店编码", example="99")
    private Integer branchNum;
    @ApiCloudField(value="应用门店编码", example="1")
    private Integer applyBranchNum;
    @ApiCloudField(value="时间类型(审核时间、制单时间、最后修改时间)", example="制单时间", required=true)
