...
/**
 * ProcessingPlanFindV2DTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ProcessingPlanFindV2DTOModel extends ApiCloudObject {

    @ApiCloudField(value="门店编号（时间类型为最后修改时间允许为空）", example="1")
    private Integer branchNum;
    @ApiCloudField(value="时间类型(制单时间|审核时间|截止时间|最后修改时间)", example="审核时间", required=true)
