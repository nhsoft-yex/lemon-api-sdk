...
/**
 * SupplierPreSettlementUpdateRequestDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class SupplierPreSettlementUpdateRequestDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="关联采购订单", example="PO2072990002548")
