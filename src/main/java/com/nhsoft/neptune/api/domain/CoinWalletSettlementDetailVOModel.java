...
public class CoinWalletSettlementDetailVOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="交班日期")
    private String shiftTableBizday;
    @ApiCloudField(value="操作时间")
    private String createdAt;
    @ApiCloudField(value="类型(零钱包用)")
    private String type;
    ...
    @ApiCloudField(value="卡号(若是券结算，则存券号)")
    private String cardPrintedNum;
    @ApiCloudField(value="卡类型名称(若是券结算，则存券类型名称)")
    private String cardTypeName;
    @ApiCloudField(value="次卡结算的结算类型")
    private String exchangeCardSettlementScope;
    @ApiCloudField(value="门店名称(次卡购买记录时指购买门店，消费记录时指消费门店，退款记录时指退款门店)")
