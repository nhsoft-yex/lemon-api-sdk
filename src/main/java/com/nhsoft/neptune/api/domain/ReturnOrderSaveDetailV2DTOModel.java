...
/**
 * ReturnOrderSaveDetailV2DTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ReturnOrderSaveDetailV2DTOModel extends ApiCloudObject {

    @ApiCloudField(value="商品编码", example="150050001", required=true)
    private Integer itemNum;
    @ApiCloudField(value="退货数量（小数点3位）", example="1.0", required=true)
    private BigDecimal itemUseQty;
    @ApiCloudField(value="退货单价（小数点4位）", example="1.0", required=true)
    private BigDecimal itemUsePrice;
    @ApiCloudField(value="退货单位", example="公斤", required=true)
