...
/**
 * PriceAdjustmentDetailSaveDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class PriceAdjustmentDetailSaveDTOModel extends ApiCloudObject {

    @ApiCloudField(value="商品编码", example="102207121", required=true)
    private Integer itemNum;
    @ApiCloudField(value="分级商品编码", example="103112312")
