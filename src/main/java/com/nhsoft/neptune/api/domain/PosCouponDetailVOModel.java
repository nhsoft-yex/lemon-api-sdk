...
public class PosCouponDetailVOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="券类型(1:消费券；2：次卡)", example="1")
    ...
    @ApiCloudField(value="次卡核销次数", example="1")
    private Integer couponDetailVerificationCount;
}
