...
/**
 * WholesaleOrderDetailUpdateDTO模型
 * 批发销售单明细更新
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class WholesaleOrderDetailUpdateDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="赠品数量（小数点3位）", example="5.0")
    ...
    @ApiCloudField(value="wholesale_order_detail_use_qty")
    private BigDecimal wholesaleOrderDetailUseQty;
    @ApiCloudField(value="wholesale_order_detail_post_fee")
    private BigDecimal wholesaleOrderDetailPostFee;
}
