...
/**
 * ItemCategorySaveV2DTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class ItemCategorySaveV2DTOModel extends ApiCloudObject {

    @ApiCloudField(value="商品类别代码", example="011")
    private String categoryCode;
    @ApiCloudField(value="商品类别名称", example="果蔬")
    private String categoryName;
    @ApiCloudField(value="速记码", example="GS")
    private String categoryShortName;
    @ApiCloudField(value="商品父类代码", example="01")
