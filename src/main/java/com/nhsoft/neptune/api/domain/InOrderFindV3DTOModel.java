...
public class InOrderFindV3DTOModel extends ApiCloudObject {

    @ApiCloudField(value="调入门店编码（时间类型为最后修改时间允许为空）", example="99")
    ...
    @ApiCloudField(value="时间类型:制单时间、审核时间、最后修改时间、签收时间、调入日期", example="审核时间", required=true)
