...
/**
 * MakeUpOrderSupplierFindRequestDTO模型
 */
@Data
@EqualsAndHashCode(callSuper = true)
public class MakeUpOrderSupplierFindRequestDTOModel extends ApiCloudObject {
    ...
    @ApiCloudField(value="门店编码", example="43440001")
