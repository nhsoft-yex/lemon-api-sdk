...
/**
 * wholesaleOrderAudit请求类
 * 批发销售单审核
 */
public class WholesaleOrderAuditRequest implements ApiCloudRequest<WholesaleOrderUpdateDTOModel, WholesaleOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.order.audit";
    }
