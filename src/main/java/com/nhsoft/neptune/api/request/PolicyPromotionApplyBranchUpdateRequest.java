...
/**
 * policyPromotionBranchUpdate请求类
 * 促销特价应用门店修改
 */
public class PolicyPromotionApplyBranchUpdateRequest implements ApiCloudRequest<PolicyApplyBranchUpdateDTOModel, Void> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.policy.promotion.apply.branch.update";
    }
