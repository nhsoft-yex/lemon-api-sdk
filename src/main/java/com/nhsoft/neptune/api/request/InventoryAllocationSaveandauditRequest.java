...
/**
 * allocationSaveAndAudit请求类
 * 库存转仓单保存加审核
 */
public class InventoryAllocationSaveandauditRequest implements ApiCloudRequest<AllocationOrderSaveV2DTOModel, AllocationOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.inventory.allocation.saveandaudit";
    }
