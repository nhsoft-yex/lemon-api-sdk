 ...
 * 调出单审核
 */
public class ChainOutorderAuditv2Request implements ApiCloudRequest<OutOrderUpdateV2DTOModel, OutOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.chain.outorder.audit/v2";
    }
