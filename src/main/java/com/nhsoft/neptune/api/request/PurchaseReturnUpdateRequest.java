 ...
 * 退货单修改
 */
public class PurchaseReturnUpdateRequest implements ApiCloudRequest<ReturnOrderUpdateV2DTOModel, ReturnOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.purchase.return.update";
    }
