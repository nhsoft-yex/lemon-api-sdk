...
/**
 * InOrderSaveAndAudit请求类
 * 调入单保存加审核
 */
public class ChainInorderSaveandauditRequest implements ApiCloudRequest<InOrderSaveV2DTOModel, InOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.chain.inorder.saveandaudit";
    }
