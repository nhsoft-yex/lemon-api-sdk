...
/**
 * wholesaleBookAudit请求类
 * 批发订单审核
 */
public class WholesaleBookAuditRequest implements ApiCloudRequest<WholesaleBookUpdateDTOModel, WholesaleBookVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.book.audit";
    }
