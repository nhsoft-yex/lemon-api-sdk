...
/**
 * outOrderSaveAndAuditV2请求类
 * 调出单保存并审核
 */
public class ChainOutorderSaveandauditv2Request implements ApiCloudRequest<OutOrderSaveV2DTOModel, OutOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.chain.outorder.saveandaudit/v2";
    }
