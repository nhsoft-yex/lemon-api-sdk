...
/**
 * saveAndAuditWholesalePriceAdjust请求类
 * 批发价调整单新增并审核
 */
public class WholesalePriceAdjustSaveandauditRequest implements ApiCloudRequest<WholesalePriceAdjustOrderSaveDTOModel, WholesalePriceAdjustOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.price.adjust.saveandaudit";
    }
