 ...
 * 调出单修改
 */
public class ChainOutorderUpdateRequest implements ApiCloudRequest<OutOrderUpdateV2DTOModel, OutOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.chain.outorder.update";
    }
