...
/**
 * elepriceadjSaveAndAudit请求类
 * 成分商品调价新增并审核
 */
public class BasicElepriceadjSaveandauditRequest implements ApiCloudRequest<ElepriceadjSaveV2DTOModel, ElepriceadjV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.basic.elepriceadj.saveandaudit";
    }
