...
/**
 * receiveOrderSaveAndAudit请求类
 * 收货单新增并审核
 */
public class PurchaseReceiveSaveandauditRequest implements ApiCloudRequest<ReceiveOrderSaveV2DTOModel, ReceiveOrderFindV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.purchase.receive.saveandaudit";
    }
