...
/**
 * priceadjustmentUpdate请求类
 * 库存成本调整单修改
 */
public class InventoryPriceadjustmentUpdateRequest implements ApiCloudRequest<PriceAdjustmentOrderUpdateV3DTOModel, PriceAdjustmentOrderV3DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.inventory.priceadjustment.update";
    }
