 ...
 * 成分商品调价审核
 */
public class BasicElepriceadjAuditRequest implements ApiCloudRequest<ElepriceadjUpdateV2DTOModel, ElepriceadjV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.basic.elepriceadj.audit";
    }
