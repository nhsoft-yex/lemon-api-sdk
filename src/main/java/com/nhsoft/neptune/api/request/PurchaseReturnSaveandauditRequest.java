...
/**
 * returnSaveAndAudit请求类
 * 退货单保存并审核
 */
public class PurchaseReturnSaveandauditRequest implements ApiCloudRequest<ReturnOrderSaveV2DTOModel, ReturnOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.purchase.return.saveandaudit";
    }
