...
/**
 * receiveOrderAudit请求类
 * 收货单审核
 */
public class PurchaseReceiveAuditRequest implements ApiCloudRequest<ReceiveOrderUpdateV2DTOModel, ReceiveOrderFindV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.purchase.receive.audit";
    }
