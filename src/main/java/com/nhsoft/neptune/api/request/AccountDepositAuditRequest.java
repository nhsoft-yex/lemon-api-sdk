...
/**
 * accountDepositAudit请求类
 * 门店账户充值单审核
 */
public class AccountDepositAuditRequest implements ApiCloudRequest<AccountDepositUpdateV2DTOModel, AccountDepositV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.account.deposit.audit";
    }
