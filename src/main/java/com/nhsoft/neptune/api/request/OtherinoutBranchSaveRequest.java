...
/**
 * branchOtherInoutSave请求类
 * 门店费用单新增
 */
public class OtherinoutBranchSaveRequest implements ApiCloudRequest<BranchOtherInoutSaveDTOModel, BranchOtherInoutDTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.otherinout.branch.save";
    }
