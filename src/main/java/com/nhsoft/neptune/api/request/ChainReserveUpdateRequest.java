 ...
 * 预定活动修改
 */
public class ChainReserveUpdateRequest implements ApiCloudRequest<ReserveUpdateV2DTOModel, ReserveOrderFindV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.chain.reserve.update";
    }
