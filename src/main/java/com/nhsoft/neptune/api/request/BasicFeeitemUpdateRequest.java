...
/**
 * updateBasicFeeItem请求类
 * 费用项目修改
 */
public class BasicFeeitemUpdateRequest implements ApiCloudRequest<BasicFeeItemSaveDTOModel, BasicFeeItemDTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.basic.feeitem.update";
    }
