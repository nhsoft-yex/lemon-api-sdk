...
/**
 * updateTransferPriceAdjust请求类
 * 配送价调整单更新
 */
public class BasicTransferPriceAdjustUpdateRequest implements ApiCloudRequest<TransferPriceAdjustOrderUpdateDTOModel, TransferPriceAdjustOrderDTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.basic.transfer.price.adjust.update";
    }
