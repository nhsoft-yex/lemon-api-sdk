...
/**
 * readBasketBorrowOrder请求类
 * 新增并审核筐借还单
 */
public class WmsBasketBorrowOrderSaveandauditRequest implements ApiCloudRequest<BasketBorrowOrderSaveDTOModel, BasketBorrowOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.wms.basket.borrow.order.saveandaudit";
    }
