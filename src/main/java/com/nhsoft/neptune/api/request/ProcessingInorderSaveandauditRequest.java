...
/**
 * saveAndAuditProcessingInOrder请求类
 * 生产入库单新增并审核
 */
public class ProcessingInorderSaveandauditRequest implements ApiCloudRequest<ProcessingInOrderSaveV2DTOModel, ProcessingInOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.processing.inorder.saveandaudit";
    }
