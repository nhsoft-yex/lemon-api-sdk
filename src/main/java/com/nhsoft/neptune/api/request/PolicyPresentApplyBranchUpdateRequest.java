...
/**
 * policyPromotionBranchUpdate_1请求类
 * 赠品促销应用门店修改
 */
public class PolicyPresentApplyBranchUpdateRequest implements ApiCloudRequest<PolicyApplyBranchUpdateDTOModel, Void> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.policy.present.apply.branch.update";
    }
