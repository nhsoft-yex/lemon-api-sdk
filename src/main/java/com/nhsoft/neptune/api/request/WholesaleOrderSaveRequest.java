...
/**
 * wholesaleOrderSave请求类
 * 批发销售单新增
 */
public class WholesaleOrderSaveRequest implements ApiCloudRequest<WholesaleOrderSaveDTOModel, WholesaleOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.order.save";
    }
