...
/**
 * findProcessingOrderV2请求类
 * 生产加工单查询
 */
public class ProcessingOrderFindv2Request implements ApiCloudRequest<OrderFindV2DTOModel, List<ProcessingOrderV2DTOModel>> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.processing.order.find/v2";
    }
