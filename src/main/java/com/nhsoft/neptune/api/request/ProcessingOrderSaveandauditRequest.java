...
/**
 * saveAndAuditProcessingOrder请求类
 * 生产加工单新增并审核
 */
public class ProcessingOrderSaveandauditRequest implements ApiCloudRequest<ProcessingOrderSaveV2DTOModel, ProcessingOrderV2DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.processing.order.saveandaudit";
    }
