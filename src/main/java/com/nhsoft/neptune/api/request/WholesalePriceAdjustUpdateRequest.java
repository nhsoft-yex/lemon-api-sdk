...
/**
 * updateWholesalePriceAdjust请求类
 * 批发价调整单修改
 */
public class WholesalePriceAdjustUpdateRequest implements ApiCloudRequest<WholesalePriceAdjustOrderUpdateDTOModel, WholesalePriceAdjustOrderVOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.wholesale.price.adjust.update";
    }
