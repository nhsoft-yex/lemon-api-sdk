...
/**
 * checkSaveAndAudit请求类
 * 库存盘点单新增并审核
 */
public class InventoryCheckSaveandauditRequest implements ApiCloudRequest<CheckOrderSaveV2DTOModel, CheckOrderV3DTOModel> {
    ...
    public String getApiMethodName() {
        return "/nhsoft.amazon.inventory.check.saveandaudit";
    }
